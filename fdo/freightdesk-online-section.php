<?php
/**
 * Purolator small online Template
 *
 * @package     Purolator Quotes
...
if(get_option('en_fdo_company_id_status') != 1) {
    $button_connect = '<a href="javascript:void(0)" id="fd_online_id_purolator_s" class="button-primary">Connect</a>';
    ...
    if(get_option('en_fdo_company_id_status') == 1) {
        $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_purolator_s" class="button-primary">Disconnect</a>';
