 ...
 * Class EnPurSpqProductDetail
 * @package EnPurSpqProductDetail
 */
if (!class_exists('EnPurSpqProductDetail')) {
    ...
    class EnPurSpqProductDetail
    {
        ...
        /**
         * Hook for call.
         * EnPurSpqProductDetail constructor.
         */
        public function __construct()
        {
            add_filter('en_app_common_plan_status', [$this, 'en_purolator_small_plan_status'], 10, 1);
         ...
         * @return array
         */
        public function en_purolator_small_plan_status($plan_status)
        {
            $en_plugin_name = 'Small Package Quotes - Purolator Edition';
            ...
            $plan_status['hazardous_material']['purolator_small'][] = 'purolator_small';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['hazardous_material'])) {
                if (!in_array(0, $plan_status['hazardous_material']['plan_required'])) {
                    ...
                    $this->hazardous_plan_required = apply_filters("purolator_small_plans_notification_link", [2, 3]);
