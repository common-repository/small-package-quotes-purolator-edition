...
<script type="text/javascript">
    ...
    function hide_drop_val()
    {
        ...
        jQuery('.wd_dropship_wrng_address').hide();
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
    ...
    <div id="add_dropship_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup ds_popup">
            ...
            <div class="content">
                ...
                <div class="wd_dropship_wrng_address">
                    <strong>
                        Error!
                    </strong> No special characters are allowed.
                </div>
                <div class="not_allowed">
                    <p><strong>Error!</strong> Please enter US or CA zip code.</p>
                </div>
                <div class="zero_results">
                    <p><strong>Error!</strong> Please enter valid US or CA zip code.</p>
                </div>
