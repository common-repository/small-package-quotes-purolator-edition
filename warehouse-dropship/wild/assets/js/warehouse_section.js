jQuery(document).ready(function () {
    jQuery("#en_wd_origin_zip , #en_wd_origin_city , #en_wd_origin_state , #en_wd_origin_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee").focus(function (e) {
        jQuery("#add_warehouses #" + this.id).css({'border-color': '#ddd'});
    });

    jQuery("#en_wd_dropship_nickname , #en_wd_dropship_zip , #en_wd_dropship_city , #en_wd_dropship_state, #en_wd_dropship_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee").focus(function (e) {
    ...
    function en_wd_save_warehouse() {
        ...
        switch (true) {
            ...
            case (enable_instore_pickup &&
                ...
                jQuery("#add_warehouses #instore-pickup-address").css({'border-color': '#e81123'});
                jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                setTimeout(function () {
            ...
            case (enable_instore_pickup &&
                (instore_pickup_miles?.split('.')[0]?.length > 4 || instore_pickup_miles?.split('.')[1]?.length > 2)):
                jQuery('.wrng_instore').show('slow');
                jQuery("#add_warehouses #instore-pickup-address").css({'border-color': '#e81123'});
                jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                setTimeout(function () {
            ...
            case (enable_local_delivery && local_delivary_fee && !((/^([0-9]{1,4})?\.?([0-9]{1,2})$/).test(local_delivary_fee))):
                jQuery('.dynamic_warehouse_error').show('slow');
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    ...
                    jQuery('.wd_warehouse_wrng_address').show('slow');
                    jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                    setTimeout(function () {
                        jQuery('.wd_warehouse_wrng_address').hide('slow');
                    }, 5000);
                } else {
    ...
    function en_wd_save_dropship() {
        ...
        switch (true) {
            ...
            case (enable_instore_pickup &&
                ...
                jQuery('.wrng_instore').show('slow');
                jQuery("#add_dropships #instore-pickup-address").css({'border-color': '#e81123'});
                jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                setTimeout(function () {
                    jQuery('.wrng_instore').hide('slow');
                }, 5000);
            ...
            case (enable_local_delivery && dropship_local_delivary_fee && !((/^([0-9]{1,4})?\.?([0-9]{1,2})$/).test(dropship_local_delivary_fee))):
            ...
            case (enable_local_delivery && dropship_local_delivary_fee && dropship_local_delivary_fee.split('.')[0]?.length > 4):
                ...
                jQuery("#add_dropships #local-delivery-fee").css({'border-color': '#e81123'});
                return false;
            case (enable_local_delivery && dropship_local_delivary_fee && dropship_local_delivary_fee.split('.')[1]?.length > 2):
                jQuery("#add_dropships #local-delivery-fee").parent().find(".en_wd_err").html("Local delivery fee format should be 100.20 or 10% and only 2 digits are allowed after decimal point.");
                jQuery("#add_dropships #local-delivery-fee").css({'border-color': '#e81123'});
                return false;
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    ...
                    jQuery('.wd_dropship_wrng_address').show('slow');
                    jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                    setTimeout(function () {
                        jQuery('.wd_dropship_wrng_address').hide('slow');
                    }, 5000);
                } else {
                    jQuery('.already_exist').show('slow');
                    jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
...
function stopSpecialCharacters(e) {
    ...
    // Allow: backspace, delete, tab, escape, enter and .
    if (jQuery.inArray(e.keyCode, [46, 27, 13, 110, 190, 189]) !== -1 ||
        // Allow: Ctrl+A, Command+A
        (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) ||
        // Allow: home, end, left, right, down, up
        (e.keyCode >= 35 && e.keyCode <= 40)) {
    ...
    // Ensure that it is a number and stop the keypress
    if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 90)) && (e.keyCode < 96 || e.keyCode > 105) && e.keyCode != 186 && e.keyCode != 8 && e.keyCode != 9) {
        e.preventDefault();
    }
