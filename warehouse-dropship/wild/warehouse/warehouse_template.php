...
<script type="text/javascript">
    ...
    function en_wd_add_warehouse_btn()
    {
        ...
        jQuery('.wd_warehouse_wrng_address').hide();
    ...
    function change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/small-package-quotes-purolator-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
    ...
    <div id="en_wd_add_warehouse_btn" class="en_wd_warehouse_overlay">
        <div class="en_wd_add_warehouse_popup">
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <div class="wd_warehouse_wrng_address">
                    <strong>
                        Error!
