 ...
 */
if (!class_exists('EnPurolatorSpqOrderRates')) {

    class EnPurolatorSpqOrderRates
    {
        ...
        public function en_order_before_calculate_totals($and_taxes, $order)
        {
            ...
            if (isset($woocommerce->cart)) {
                ...
                foreach ($shipping as $item_id => $per_shipment) {
                    ...
                    switch ($method_id) {
                        case 'purolator_small':
                            ...
                            if (empty($errors)) {
                                $shipping_class = new WC_purolator_small();
                ...
                if ($order_recreated) {
                    ...
                    $pur_curl_obj = new Purolator_Small_Curl_Request();
                    $pur_curl_obj->purolator_small_get_curl_response(PUROLATOR_FDO_HITTING_URL, $request_data);
                }
            }
        }
    }

    new EnPurolatorSpqOrderRates();
}